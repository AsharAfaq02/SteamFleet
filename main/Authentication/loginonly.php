...
function rdirect($url){
    ...
    $conn = new mysqli($servername, $username, $password, $dbname);
      ...
      if($email != '' && $password != ''){
         $query = " SELECT 1 FROM ArchLogin WHERE Email = '$email' AND Password = '$password'";
  }
          ...
          if($rowval == "1"){
        	   rdirect('/main/Authentication/main_storyboard/storyBoard.php');
        	}
        	if($rowval != "1" && $email != '' && $password != ''){
    				  echo "<h1 style = 'color:red; text-align:center; font-size: 2vw'>INVALID CREDENTIALS, PLEASE TRY AGAIN <br> <a href = '/main' class = 'text-align:center'>Sign Up!</a?</h1>";
					}
  }
